   ...
   if (typeof window != 'undefined') {
     ...
     return (
       <div className='flex flex-col w-full h-screen gap-10 py-10 bg-[#0E0628]'>
           <Link href={`/summary/${id}`} className='bg-gray-200 p-4 text-xl text-center font-bold'>Study Guide</Link>
           <Link href={`/summary/question?id=${id}`} className='bg-gray-200 p-4 text-xl text-center font-bold'>Question</Link>
