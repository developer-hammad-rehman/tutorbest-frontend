      ...
      <div className="bg-[#100D20] px-7 py-10 flex items-center my-6 justify-around rounded-xl">
        ...
        <div className="lg:border-l-2 lg:px-10">
          ...
          >
            ...
            <Link href={'/api/cookies'} className="px-6 py-3 text-white flex gap-5 border-2 border-gray-600 hover:border-purple-700 transition-colors duration-1000 rounded-xl">
