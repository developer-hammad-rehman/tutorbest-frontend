...
export default function SignUp() {
 ...
 const {push}= useRouter()
  const onSubmit: SubmitHandler<FormInput> = async (data) => {
    ...
    reset();
    console.log(data);
    const fetcher = await fetch("/api/sigin", {
      method: "POST",
      headers: {
      ...
      <div className="bg-[#100D20] px-7 py-10 flex items-center my-6 justify-around rounded-xl">
        ...
        <div className="lg:border-l-2 lg:px-10">
          ...
          >
            ...
            <Link href={'tutorbest-vercel-fastapi.vercel.app/api/google/login'} className="px-6 py-3 text-white flex gap-5 border-2 border-gray-600 hover:border-purple-700 transition-colors duration-1000 rounded-xl">
